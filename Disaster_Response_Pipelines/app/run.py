...
def index():
    ...
    layout1 = Layout(title= 'Distribution of Message Genres',
                     yaxis= {'title': "Count"},
                     xaxis= {'title': "Genre"})
    figure1 = Figure(data = trace1, layout = layout1)
    ...
    figure2 = Figure(data = trace2, layout = layout2)
    ...
    figure3 = Figure(data = trace3, layout = layout3)
    ...
    figure4 = Figure(data = trace4, layout = layout4)

    graphs = [figure1, figure2, figure3, figure4]
